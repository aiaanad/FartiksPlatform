...
public class WalletsController : ControllerBase
{
    ...
    public async Task<IActionResult> GetMyBalances()
    {
        ...
        Wallet? goldWallet = await _walletRepository.GetByPlayerAndCurrencyAsync(playerId, CurrencyType.Gold);
        Wallet? diamondWallet = await _walletRepository.GetByPlayerAndCurrencyAsync(playerId, CurrencyType.Diamond);
